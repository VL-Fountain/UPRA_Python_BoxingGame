...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load("conceptP1.png")
    ...
    def update(self):
        ...
        if player.leftDodge == True and self.rightPunch == False and self.leftPunch == False:
            self.image = pygame.image.load("leftDodgeP1.png")
            self.rect.x = self.basePos[0] - 40
        elif player.rightDodge == True and self.rightPunch == False and self.leftPunch == False:
            self.image = pygame.image.load("rightDodgeP1.png")
            self.rect.x = self.basePos[0] + 40
        elif self.leftPunch == True:
            #print("punch?")
            self.image = pygame.image.load("leftPunchP1.png")
        elif self.rightPunch == True:
            #print("punch?")
            self.image = pygame.image.load("rightPunchP1.png")        
        else:
            self.image = pygame.image.load("conceptP1.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load("conceptP2.png")
    ...
    def update(self):
        ...
        if self.leftHint == True:
            self.image = pygame.image.load("leftHintP2.png")
        elif self.rightHint == True:
            self.image = pygame.image.load("rightHintP2.png")
        elif self.leftPunch == True:
            self.image = pygame.image.load("leftPunchP2.png")
        elif self.rightPunch == True:
            self.image = pygame.image.load("rightPunchP2.png")
        elif self.guard == True and self.isStunned == False:
            self.image = pygame.image.load("blockP2.png")
        elif self.isStunned == True:
            self.image = pygame.image.load("stunP2.png")
        else:
            self.image = pygame.image.load("conceptP2.png")
            self.rythmTimer += 1
            if self.rythmTimer % 12 == 0:
...
class HP(pygame.sprite.Sprite):
    def __init__(self, Player):
        super().__init__()    
        self.image = pygame.image.load("playerHP3.png")
    ...
    def update(self):
        ...
        if self.health == 2:
            self.dbU = False
            self.image = pygame.image.load("playerHP2.png")
        elif self.health == 1:
            self.image = pygame.image.load("playerHP1.png")
        elif self.health == 0:
            self.image = pygame.image.load("playerHP0.png")
        elif self.health == 3:
            self.image = pygame.image.load("playerHP3.png")
...
class HPE(pygame.sprite.Sprite): 
    def __init__(self,Enemy):
        super().__init__()    
        self.image = pygame.image.load("enemyHP7.png")
    ...
    def update(self):
       # if self.dbU == False:
        ...
        if self.health == 6:
            self.dbU = False
            self.image = pygame.image.load("enemyHP6.png")
        elif self.health == 5:
            self.image = pygame.image.load("enemyHP5.png")
        elif self.health == 4:
            self.image = pygame.image.load("enemyHP4.png")
        elif self.health == 3:
            self.image = pygame.image.load("enemyHP3.png")
        elif self.health == 2:
            self.image = pygame.image.load("enemyHP2.png")
        elif self.health == 1:
            self.image = pygame.image.load("enemyHP1.png")
        elif self.health == 0:
            self.image = pygame.image.load("enemyHP0.png")
        elif self.health == 7:
            self.image = pygame.image.load("enemyHP7.png")             
...
while not done:
    ...
    if eventScreen == 0:
        screen.fill(BLACK)
        font = pygame.font.SysFont("emulogic", 20)
